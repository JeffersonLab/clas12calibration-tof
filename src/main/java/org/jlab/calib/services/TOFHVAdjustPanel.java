...
public class TOFHVAdjustPanel extends JPanel implements ActionListener {
	...
	public TOFHVAdjustPanel(TofHVEventListener hvIn, TOFCalibration tofCalIn) {
		...
		calib = new CalibrationConstants(3, "current_HV_left/F:current_HV_right/F:new_HV_left/F:new_HV_right/F");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().compareTo("Select File") == 0) {
			...
			// File("/home/louise/FTOF_calib_rewrite/input_files/hvfiles"));
		...
		try {
			...
			while (line != null) {
				...
				if (newHV != origVoltage) {
					...
					outputBw.write(
							commandString + " 1 " + new DecimalFormat("0.00000E00").format(newHV).replace("E", "e+"));
					outputBw.newLine();
