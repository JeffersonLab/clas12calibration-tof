...
public class TofTimingOptionsPanel extends JPanel implements ActionListener {
    ...
    JRadioButton[]   stepRadiosPrev = {new JRadioButton(), new JRadioButton(), new JRadioButton()};
    JRadioButton[]   stepRadiosNew = {new JRadioButton(), new JRadioButton(), new JRadioButton()};
	...
	public TofTimingOptionsPanel(){
		...
		ButtonGroup[] radGroups = {new ButtonGroup(), new ButtonGroup(), new ButtonGroup()};
		c.gridx = 1;
		c.gridy = 0;
